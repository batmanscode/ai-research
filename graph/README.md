...
Each graph-theory project has a descriptive folder containing its result,
evidence, research history, design contract, and deployable visual paper.
...
| [`secure-domination-optimal-coefficient/`](secure-domination-optimal-coefficient/) | Active continuation: the `alpha=3` slice is exact; cut vertices, dominating paths, and dominating triangles satisfy `gamma_s <= alpha+1`; connected residuals and nested missed-hub sets constrain the remaining inclusion-minimal dominating cliques of order at least four. | Not yet a finished visual paper; the exact coefficient remains open. |
